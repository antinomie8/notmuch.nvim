...
vim.keymap.set("n", "v", function() require("nomtuch.attach").view_attachment_part() end, { buffer = true })
vim.keymap.set("n", "o", function() require("nomtuch.attach").open_attachment_part() end, { buffer = true })
